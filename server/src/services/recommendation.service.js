...
async function ensureDeviceBelongsToChildAndParent(deviceId, parentId, childId) {
...
export async function getParentRecommendations(parentId, childId, deviceId) {
  ...
  const device = await ensureDeviceBelongsToChildAndParent(deviceId, parentId, childId);
